...
<html>
 <head>
	...
	<script type="text/javascript">
		const addrInfo = ${requestScope.addr};
	</script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery-3.7.1.min.js"></script>
	<script src="${pageContext.request.contextPath}/bootstrap-4.6.2-dist/js/bootstrap.bundle.min.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/mypage/addressEdit.js"></script>
		...
		<div id="menu_container" style="border:0px solid black">
			<div id="address_input">
				<form id="address_form">
					...
					<input class="input_area" name="address_no" type="text"
						value = ${requestScope.address_no} id="address_no" style="display: none" />
						<input class="input_area" name="action" type="text"
						value = editComplete style="display: none" />
