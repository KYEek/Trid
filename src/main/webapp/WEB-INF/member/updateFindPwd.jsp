...
<!-- 직접 만든 JS -->
<script type="text/javascript" src="<%= ctx_Path%>/js/member/updateFindPwd.js"></script>
...
<jsp:include page="../header.jsp"/>
	<form name="FindPwdUpdateFrm" action="">
		<div id="container">
			<div id="update">비밀번호 변경</div>
			
			
	        <input type="password" name="newPwd" id="newPwd" maxlength="15" class="requiredInfo" placeholder="새 비밀번호" />
	        <div class="newPwd_message message" style="color: red"><i class="fa-solid fa-circle-info"></i>&nbsp;안전한 비밀번호를 입력하세요. 영어대소문자,숫자 및 특수기호를 포함한 최소 8자리 이상이어야 합니다.</div>
	        
	        
	        <input type="password" name="newPwdCheck" id="newPwdCheck" maxlength="15" class="requiredInfo" placeholder="새 비밀번호 확인" />
	        <div class="newPwdCheck_message message" style="color: red"><i class="fa-solid fa-circle-info"></i>&nbsp;비밀번호가 일치하지 않습니다.</div>
	        
	        
	        <input type="hidden" name="mobile" id="mobile" value="${requestScope.mobile}"/>
