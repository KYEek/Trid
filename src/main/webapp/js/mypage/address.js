			...
			// html 코드를 담을 변수를 설정합니다.
		      ...
		      for (let info in item) {
		        ...
		        if (info == "addr_isdefault") {
		          if (item[info] == 1) {
		            addr_isdefault = "<li style ><div id='is_default_address'>기본 주소</div></li>";
		            is_default = true;
		          }
		        } else {
			  ...
			  //순서에 맞게 값을 넣습니다
		      html = html + member_name + addr_address + addr_detail + addr_extraaddr + addr_post_no + member_mobile + addr_isdefault;
